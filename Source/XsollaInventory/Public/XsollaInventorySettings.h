...
public:
	...
	UPROPERTY(Config, EditAnywhere, BlueprintReadWrite, DisplayName = "Use Cross-Platform Account Linking", Category = "Xsolla Inventory Settings")
	...
	UPROPERTY(Config, EditAnywhere, BlueprintReadWrite, Category = "Xsolla Inventory Settings", meta = (EditCondition = "UseCrossPlatformAccountLinking"))
