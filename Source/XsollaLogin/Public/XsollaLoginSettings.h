...
/** You can store user data on the Xsolla side (default option) or in your own storage. */
UENUM(BlueprintType)
...
public:
	...
	/**
	 * URL that is used to link the user platform account to the main account with a generated code.
	...
	/** URL that is used for a target platform user account authentication. */
	UPROPERTY(Config, EditAnywhere, BlueprintReadOnly, Category = "Xsolla Login Settings", meta = (EditCondition = "UseCrossPlatformAccountLinking"))
	FString PlatformAuthenticationURL;

	/** Target platform for cross-platform account linking. If you use Xsolla Store, make sure you selected the same platform in the Store settings. */
	UPROPERTY(Config, EditAnywhere, BlueprintReadOnly, Category = "Xsolla Login Settings", meta = (EditCondition = "UseCrossPlatformAccountLinking"))
	...
	/** Requests user nickname after successful authorization in case one is missing. */
	UPROPERTY(Config, EditAnywhere, BlueprintReadOnly, Category = "Xsolla Login Demo")
	bool RequestNickname;

	/** If enabled, the Login SDK will use Steam as a default authorization mechanism. */
	UPROPERTY(Config, EditAnywhere, BlueprintReadOnly, Category = "Xsolla Login Demo")
