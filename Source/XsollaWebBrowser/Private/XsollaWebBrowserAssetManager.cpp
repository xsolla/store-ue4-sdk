...
UXsollaWebBrowserAssetManager::UXsollaWebBrowserAssetManager(const FObjectInitializer& ObjectInitializer)
	...
	, DefaultMaterial(FString(TEXT("/Xsolla/Browser/M_WebTexture.M_WebTexture")))
	, DefaultTranslucentMaterial(FString(TEXT("/Xsolla/Browser/M_WebTexture_Translucent.M_WebTexture_Translucent")))
{
#if WITH_EDITOR || PLATFORM_ANDROID || PLATFORM_IOS
