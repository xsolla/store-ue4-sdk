...
{
	static ConstructorHelpers::FClassFinder<UXsollaUIBuilderTheme> ThemeFinder(*FString::Printf(TEXT("/%s/Demo/UIBuilder/BP_DefaultTheme.BP_DefaultTheme_C"),
		*UXsollaUtilsLibrary::GetPluginName(FXsollaUIBuilderModule::ModuleName)));
	static ConstructorHelpers::FClassFinder<UXsollaUIBuilderWidgetsLibrary> WidgetsLibraryFinder(*FString::Printf(TEXT("/%s/Demo/UIBuilder/BP_DefaultWidgetsLibrary.BP_DefaultWidgetsLibrary_C"),
		*UXsollaUtilsLibrary::GetPluginName(FXsollaUIBuilderModule::ModuleName)));
